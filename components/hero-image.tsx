...
const HeroImage = () => (
  ...
  >
   ...
   `}
    ...
    <g className='filler' fill={fillColor}>
    ...
    <g
      id='midground'
      data-name=' 3-midground'
      className='midBuildings'
      fill={fillColor}
    >
    ...
    <g id='_2-willis' className='willis' fill={fillColor} opacity='0.78'>
    ...
    <g id='circles'>
      <g>
        <circle className='stroke-nofill' cx='91.2' cy='341.4' r='24' />
        <circle className='stroke-nofill' cx='91.2' cy='341.4' r='32' />
        <circle
          className='stroke-nofill'
          cx='91.2'
          cy='341.43'
          r='45.4'
          transform='translate(-259.7 383.4) rotate(-81.86)'
        />
